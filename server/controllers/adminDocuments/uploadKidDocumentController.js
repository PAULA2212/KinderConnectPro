...
// Controlador para subir archivos relacionados con niños
const uploadKidFile = async (req, res) => {
    // Extrae el nombre del archivo y el ID del niño del cuerpo de la solicitud
    const { nombre, kid_id } = req.body; 
...
// Exporta la función uploadKidFile para su uso en otras partes de la aplicación

...
/**
 * Vincula un niño con un progenitor en la base de datos.
 *
...
const linkedKidParents = async (req, res) => {
    ...
    console.log('id_progenitor:', id);
    console.log('codigo_unico:', unique_code);
    ...
    try {
        ...
        // Verificar si ya existe una vinculación entre el progenitor y el niño
        ...
        if (existingLink.length === 0) {
            // Vincular el niño con el progenitor
            console.log('Vinculando el niño con el progenitor');
            await promisePool.query(
                `INSERT INTO progenitores_niños (id_progenitor, id_niño) VALUES (?, ?)`,
                [id, id_niño] // Corrección del nombre de la variable aquí
            );
            res.status(201).json({ message: 'Niño vinculado con el progenitor exitosamente' }); // Respuesta de éxito
        } else {

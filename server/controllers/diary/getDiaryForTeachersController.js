...
// Controlador para obtener el diario de progenitores para un niño específico
const getDiaryForteachers = async (req, res) => {
    ...
    try {
        ...
        const [rows] = await promisePool.query(
            'SELECT * FROM diario_progenitores WHERE id_niño = ? ORDER BY fecha DESC', // Consulta para obtener los datos del diario de los progenitores
...
module.exports = getDiaryForteachers; // Exporta el controlador para su uso en otras partes de la aplicación
